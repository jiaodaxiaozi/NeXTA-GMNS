...
public:
	...
	std::map<long, long> g_internal_node_seq_no_map;  // hush table, map external node number to internal node sequence no. 
	std::map<long, long> g_zoneid_to_zone_seq_no_mapping;
...
extern std::map<long, long> g_zoneid_to_zone_seq_no_mapping;
